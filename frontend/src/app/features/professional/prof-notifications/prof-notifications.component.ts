...
export class ProfNotificationsComponent implements OnInit {
  ...
  typeIcon(type: string): string {
    const map: Record<string, string> = {
      ...
      SUSPENSION_NOTICE:     'M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636',
      REACTIVATED:           'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z',
